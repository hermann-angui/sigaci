...
class Payment
{
     ...
     * @return Payment
     */
    public function setReceiptNumber(?string $receipt_number): self
    {
     ...
     * @return Payment
     */
    public function setCodePaymentOperateur(?string $code_payment_operateur): self
    {
     ...
     * @return Payment
     */
    public function setReceiptFile(?string $receipt_file): self
    {
